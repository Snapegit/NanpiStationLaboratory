				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="设备编号" prop="shebeibianhao">
							<el-input class="list_inp" v-model="form.shebeibianhao" :readonly="true" placeholder="设备编号" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="设备状态" prop="shebeizhuangtai">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.shebeizhuangtai?true:false"
								v-model="form.shebeizhuangtai" 
								placeholder="请选择设备状态"
								>
								<el-option v-for="(item,index) in shebeizhuangtaiLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="24">
						<el-form-item label="设备详情" prop="shebeixiangqing">
							<editor :value="form.shebeixiangqing" placeholder="请输入设备详情" :readonly="!isAdd||disabledForm.shebeixiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'shebeixiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.shebeixiangqing = res.data.data.shebeixiangqing?(res.data.data.shebeixiangqing.replace(reg,'../../../cl06631205/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='shebeizhuangtai'){
					form.value.shebeizhuangtai = row[x];
					disabledForm.value.shebeizhuangtai = true;
					continue;
				}
				if(x=='shebeixiangqing'){
					form.value.shebeixiangqing = row[x];
					disabledForm.value.shebeixiangqing = true;
					continue;
				}
			}
			if(row){
