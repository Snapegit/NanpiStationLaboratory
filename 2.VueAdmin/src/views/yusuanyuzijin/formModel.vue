	...
	<div>
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					<el-col :span="12">
						<el-form-item label="收支类别" prop="shouzhileibie">
							<el-input class="list_inp" v-model="form.shouzhileibie" placeholder="收支类别"
								 type="text" 								:readonly="!isAdd||disabledForm.shouzhileibie?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="资金去向" prop="zijinquxiang">
							<el-input class="list_inp" v-model="form.zijinquxiang" placeholder="资金去向"
								 type="text" 								:readonly="!isAdd||disabledForm.zijinquxiang?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='shouzhileibie'){
					form.value.shouzhileibie = row[x];
					disabledForm.value.shouzhileibie = true;
					continue;
				}
				if(x=='jine'){
				...
				if(x=='zijinquxiang'){
					form.value.zijinquxiang = row[x];
					disabledForm.value.zijinquxiang = true;
					continue;
				}
