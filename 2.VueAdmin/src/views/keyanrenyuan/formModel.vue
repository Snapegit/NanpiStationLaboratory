				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="科研密码" prop="keyanmima">
							<el-input class="list_inp" v-model="form.keyanmima" placeholder="科研密码"
								type="password" :readonly="!isAdd||disabledForm.keyanmima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='keyanmima'){
					form.value.keyanmima = row[x];
					disabledForm.value.keyanmima = true;
					continue;
				}
