				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="科研账号" prop="keyanzhanghao">
							<el-input class="list_inp" v-model="user.keyanzhanghao" readonly placeholder="科研账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="科研密码" prop="keyanmima">
							<el-input class="list_inp" v-model="user.keyanmima" readonly placeholder="科研密码" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="科研人员姓名" prop="keyanrenyuanxingming">
							<el-input class="list_inp" v-model="user.keyanrenyuanxingming"  placeholder="科研人员姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="keyanrenyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const keyanrenyuantouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.keyanzhanghao)){
			context?.$toolUtil.message(`科研账号不能为空`,'error')
			return false
		}
		if((!user.value.keyanmima)){
			context?.$toolUtil.message(`科研密码不能为空`,'error')
			return false
		}
		if((!user.value.keyanrenyuanxingming)){
