				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="维护账号" prop="weihuzhanghao">
							<el-input class="list_inp" v-model="user.weihuzhanghao" readonly placeholder="维护账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="维护密码" prop="weihumima">
							<el-input class="list_inp" v-model="user.weihumima" readonly placeholder="维护密码" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="维护人姓名" prop="weihurenxingming">
							<el-input class="list_inp" v-model="user.weihurenxingming"  placeholder="维护人姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="weihurenyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const weihurenyuantouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.weihuzhanghao)){
			context?.$toolUtil.message(`维护账号不能为空`,'error')
			return false
		}
		if((!user.value.weihumima)){
			context?.$toolUtil.message(`维护密码不能为空`,'error')
			return false
		}
		if((!user.value.weihurenxingming)){
