				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="维护密码" prop="weihumima">
							<el-input class="list_inp" v-model="form.weihumima" placeholder="维护密码"
								type="password" :readonly="!isAdd||disabledForm.weihumima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='weihumima'){
					form.value.weihumima = row[x];
					disabledForm.value.weihumima = true;
					continue;
				}
