	...
	<div>
		<div class="login_view">
			<el-form :model="loginForm" class="login_form">
				<div class="title_view">南皮站化验室登录</div>
				...
				<div class="btn_view">
					...
					<el-button class="register" type="primary" @click="handleRegister('keyanrenyuan')">注册科研人员</el-button>
					<el-button class="register" type="primary" @click="handleRegister('weihurenyuan')">注册维护人员</el-button>
				</div>
			</el-form>
		</div>
